...
<script type="text/javascript">
	...
	function openLinkModifyDialog() {
		...
		$("#dlg").dialog("open").dialog("setTitle","修改友情连接信息");
		$("#fm").form("load",row);
...
<table id="dg" title="友情连接管理" class="easyui-datagrid" 
  ...
  <thead>
  	<tr>
  		...
  		<th field="linkName" width="200" align="center">友情连接名称</th>
  		<th field="linkUrl" width="200" align="center">友情连接地址</th>
	...
	<form id="fm" method="post">
		<table cellspacing="8px">
			...
			<tr>
				<td>友情连接地址：</td>
				<td>
					<input type="text" id="linkUrl" name="linkUrl" validType="url" class="easyui-validatebox" required="true" style="width: 250px"/>
				</td>
			</tr>
			<tr>
				<td>排序序号：</td>
				<td>
					<input type="text" id="orderNo" name="orderNo" class="easyui-numberbox" required="true" style="width: 60px"/>&nbsp;(根据排序序号从小到大排序)
				</td>
			</tr>
		</table>
	</form>
